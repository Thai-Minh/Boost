...
public class RateStarsDialog implements DialogInterface.OnClickListener {
    ...
    private static final String TAG = RateStarsDialog.class.getSimpleName();
    ...
    public RateStarsDialog(Context context, String supportEmail) {
    ...
    private void build() {
        ...
        dialogView = inflater.inflate(R.layout.gmclibs_layout_stars, null);
    ...
    private RateStarsDialog disable() {
        SharedPreferences shared = context.getSharedPreferences(context.getPackageName(), Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = shared.edit();
    ...
    public RateStarsDialog setTitle(String title) {
        this.title = title;
        return this;

    }

    public RateStarsDialog setSupportEmail(String supportEmail) {
        this.supportEmail = supportEmail;
        return this;
    }

    public RateStarsDialog setRateText(String rateText) {
        this.rateText = rateText;
        return this;
    }

    public RateStarsDialog setStarColor(int color) {
        starColor = color;
        return this;
    }

    public RateStarsDialog setPositiveButtonText(String positiveButtonText) {
        this.positiveButtonText = positiveButtonText;
        return this;
    }

    public RateStarsDialog setNegativeButtonText(String negativeButtonText) {
        this.negativeButtonText = negativeButtonText;
        return this;
    }

    public RateStarsDialog setNeutralButton(String neutralButtonText) {
     ...
     * @return
     */
    public RateStarsDialog setForceMode(boolean isForceMode) {
     ...
     * @return the dialog
     */
    public RateStarsDialog setUpperBound(int bound) {
     ...
     * @return
     */
    public RateStarsDialog setNegativeReviewListener(NegativeReviewListener listener) {
     ...
     * @return
     */
    public RateStarsDialog setReviewListener(ReviewListener listener) {
