 ...
 * <com.gmc.libs.view.ButtonDrawableCustomSize
 ...
 */
public class ButtonDrawableSize extends AppCompatButton {

    private int mDrawableWidth;
    private int mDrawableHeight;

    public ButtonDrawableSize(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public ButtonDrawableSize(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public ButtonDrawableSize(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mDrawableWidth > 0 || mDrawableHeight > 0) {
            initCompoundDrawableCustomSize();
        }
    }

    private void initCompoundDrawableCustomSize() {
