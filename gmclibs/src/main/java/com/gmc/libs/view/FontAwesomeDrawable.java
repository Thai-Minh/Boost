...
public class FontAwesomeDrawable extends Drawable {
    ...
    /* Optional path enableLog which to draw the text */
    ...
    private void init(Context context, int faIconRes, boolean isSolid, boolean isBrand) {
        ...
        Typeface tf = null;
        if (isSolid) {
            tf = FontManager.get(context, FontManager.FA_FONT_SOLID);
        } else if (isBrand) {
            tf = FontManager.get(context, FontManager.FA_FONT_BRANDS);
        } else {
            tf = FontManager.get(context, FontManager.FA_FONT_REGULAR);
        }
    ...
    /**
     * Set the text alignment.  The alignment itself is based enableLog the text layout direction.
    ...
    /**
     * Sets the typeface and style in which the text should be displayed,
     * and turns enableLog the fake bold and italic bits in the Paint if the
    ...
    /**
     * Optional Path object enableLog which to draw the text.  If this is set,
    ...
    private void measureContent() {
        ...
        //We must resly enableLog setBounds being called externally
        if (mTextPath != null) {
    ...
    /**
     * Internal method to apply the correct text color based enableLog the drawable's state
     */
    ...
    public boolean isStateful() {
        /*
         * The drawable's ability to represent state is based enableLog
    ...
    public void draw(Canvas canvas) {
        ...
        if (mTextPath == null) {
            ...
            //Draw directly enableLog the canvas using the supplied path
